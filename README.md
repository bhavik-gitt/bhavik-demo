...
- [Portfolio Sections](#-portfolio-sections)
  ...
  - [Certificates & Workshops](#-certificates--workshops)
...
`JavaScript` · `TypeScript` · `Python` · `C` · `C++` · `Java` · `SQL` · `Bash/Shell` · `Rust` · `Go` · `PHP` · `Kotlin`
...
| 5 | **iNotebook** | React · Node.js · MongoDB | [GitHub](https://github.com/bhavik-gitt/inotebook) |
| 6 | **SnipText** | React · Text utilities | [GitHub](https://github.com/bhavik-gitt/SnipText) |
| 7 | **PupJoy** | React · React Router | [GitHub](https://github.com/bhavik-gitt/pupjoy) |
| 8 | **SkillBridge AI** | Angular · Node.js · MongoDB · AI | [GitHub](https://github.com/bhavik-gitt/skillbridge-ai) |
| 9 | **FoodBridge** | TypeScript · Google Gemini AI | [GitHub](https://github.com/bhavik-gitt/FoodBridge) |
...
| Certificate / Workshop | Issuer | Type |
|---|---|---|
| Build Smarter, Scalable AI Agents with UiPath | GeeksforGeeks × UiPath | Workshop |
...
| AI Agentforce Workshop | GeeksforGeeks × Salesforce | Workshop |
...
- 🥇 **Vadodara Hackathon 6.0 (SIH 2025 Ecosystem)** — Built an AI-based Internship Recommendation Engine using AI/ML + NLP. Mobile-first, multilingual & voice-enabled for accessibility.
- 🌐 **HackCampus Polkadot BootCamp** — Parul University · Powered by PU DAO & HackTour India — built in the Web3 ecosystem.
...
*Made with ❤️ by Bhavik Ratnottar © 2026*
